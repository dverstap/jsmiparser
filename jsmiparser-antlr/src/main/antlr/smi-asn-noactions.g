...
protected objecttype_macro_accesstypes: l:LOWER 
                                        {if (l.getText().equals("read-only") || l.getText().equals("read-write") 
                                            || l.getText().equals("write-only") || l.getText().equals("read-create") 
                                            || l.getText().equals("not-accessible") || l.getText().equals("accessible-for-notify"))
                                            {/*DOSOMETHING*/} else {throw new SemanticException("(invalid)");}};
protected objecttype_macro_pibaccess: l:LOWER 
                                        {if (l.getText().equals("install") 
                                            || l.getText().equals("notify") 
                                            || l.getText().equals("install-notify") 
                                            || l.getText().equals("report-only"))
                                            {/*DOSOMETHING*/} else {throw new SemanticException("(invalid)");}};
protected objecttype_macro_statustypes: l:LOWER
                                        {if (l.getText().equals("mandatory") 
                                            || l.getText().equals("optional") 
                                            || l.getText().equals("obsolete") 
                                            || l.getText().equals("current") 
                                            || l.getText().equals("deprecated"))
                                            {/*DOSOMETHING*/} else {throw new SemanticException("(invalid)");}};
...
moduleidentity_macro_categories: l:LOWER {if (!l.getText().equals ("all")) {throw new SemanticException ("(invalid)");}} 
...
modulecompliance_macro_access: l:LOWER
                                        {if (l.getText().equals("not-accessible") 
                                                || l.getText().equals("accessible-for-notify") 
                                                || l.getText().equals("read-only")
                                                || l.getText().equals("read-write")
                                                || l.getText().equals("read-create"))
                                            {/*DOSOMETHING*/} else {throw new SemanticException("(invalid)");}};
modulecompliance_macro_pibaccess: l:LOWER
                                        {if (l.getText().equals("not-accessible") 
                                                || l.getText().equals("install") 
                                                || l.getText().equals("notify")
                                                || l.getText().equals("install-notify")
                                                || l.getText().equals("report-only"))
                                            {/*DOSOMETHING*/} else {throw new SemanticException("(invalid)");}};
...
agentcapabilities_macro_access: l:LOWER
                                        {if (l.getText().equals("not-implemented") 
                                                || l.getText().equals("accessible-for-notify") 
                                                || l.getText().equals("read-only")
                                                || l.getText().equals("read-write")
                                                || l.getText().equals("read-create")
                                                || l.getText().equals("write-only"))
                                            {/*DOSOMETHING*/} else {throw new SemanticException("(invalid)");}};
...
element_set_spec: intersections ( (BAR | UNION_KW) intersections )* 
                | ALL EXCEPT constraint_elements;

intersections: constraint_elements (EXCEPT constraint_elements)? 
                ( (INTERSECTION | INTERSECTION_KW) constraint_elements (EXCEPT constraint_elements)? )* ;
